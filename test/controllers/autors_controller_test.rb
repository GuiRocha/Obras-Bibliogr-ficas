...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference('Autor.count') do
      post autors_url, params: { autor: { nome: @autor.nome, nome_contador: @autor.nome_contador } }, as: :json
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { nome: @autor.nome, nome_contador: @autor.nome_contador } }, as: :json
    assert_response 200
  end
